...
public class WithdrawFrame extends javax.swing.JDialog {
	private static final long serialVersionUID = -2064397859067532465L;

	private IAccount account;
	private IFinCo model;
	int rowIndex;

	public WithdrawFrame(MainFrame parent, IFinCo model, IAccount account, int rowIndex) {
		super(parent);
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
		model.withdraw(account, Double.parseDouble(JTextField_AMT.getText()), rowIndex);
		dispose();
	}
