...
public class AddCompanyAccountFrame extends javax.swing.JDialog {
	private static final long serialVersionUID = 93332134983382114L;
	
	protected IFinCo model;

	public AddCompanyAccountFrame(MainFrame parent, IFinCo model) {
		super(parent);
		...
		JTextField_NE.setBounds(84, 164, 156, 20);
